...
namespace WinForms_POC_SmartHome
{
    public partial class frmPortSetup : Form
    {
        ...
        private void btnOpen_Click(object sender, EventArgs e)
        {
            ...
            //                    frmPortSetup.myPort.ReceivedBytesThreshold = 3;

            //                    //apres avoir recu 3 byte > On appel DataReceived > qui lui appel myPort_DataReceived 
            //                    frmPortSetup.myPort.DataReceived += myPort_DataReceived;
        ...
        //    {
        //        msgRecu[i] = Convert.ToByte(frmPortSetup.myPort.ReadByte());
        //    }
        ...
        //{
        //    txtDataBits.Text = b[0].ToString() + " " + b[1].ToString() + " " + b[2].ToString();
